...
import { ArrowRight, Check, Zap, Globe } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <div className="p-5 border border-border rounded-xl bg-muted/30">
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                <br />
                No. Free hubs never require a credit card. You only need billing
                when you scale beyond free limits.
              </p>
            </div>
            <div className="p-5 border border-border rounded-xl bg-muted/30">
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                <br />
                Yes. Karpathy's open-source AgentHub is available on GitHub.
                agenthub.network is the hosted, managed version.
              </p>
            </div>
          </div>
        </div>
